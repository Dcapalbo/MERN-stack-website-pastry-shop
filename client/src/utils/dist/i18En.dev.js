...
var translationEn = {
  ...
  welcome: "Welcome",
  vision: "Vision",
  visionDescription: "Luana and Maria are two passionate pastry chefs who strive to create surprising and innovative desserts using high-quality ingredients and a balance of sweetness and lightness. Their vision is to create moments of joy and sharing through food, with desserts that are not only beautiful to look at but also delicious to taste. They believe that pastry is an art and aim to express their creativity in every dessert they create.",
  sustainability: "Sustainability",
  sustainabilityDescription: "The two pastry chefs are mindful of sustainability, using local and organic ingredients, reducing waste, and offering options that are gluten-free, lactose-free, or vegan. They believe in creating inclusive desserts for everyone, without any discrimination. Moreover, they strive to collaborate with charitable associations or organizations that promote sustainability and social equity.",
  team: "The team",
  ...
  headlineLuana: "Excellence in pastry: the story of Luana, the pastry chef who loves her job.",
  descriptionLuana: "Luana is a pastry chef passionate about her work. With her creativity and skill, she manages to create delicious and visually stunning desserts, always paying attention to detail and the quality of the ingredients used. Her passion is reflected in her products, which are made with care and dedication to satisfy the tastes of every customer.",
  headlineMaria: "Maria, the pastry chef who challenges intolerances with delicious and healthy desserts",
  descriptionMaria: "Maria, an experienced pastry chef with gluten and lactose intolerances, creates delicious desserts without sacrificing the passion that drives her work. Aware of the challenges faced by those with these intolerances, Maria strives every day to offer her clients tasty and healthy desserts, crafted with care and mastery.",
  genericInfo: {
    name: "Name",
    surname: "Surname",
    email: "Email",
